            ...
            <Panel class="is-small">
                ...
                <template #icons>
                    ...
                    <div class="p-inputgroup">
                        ...
                        <Button data-testid="tags-hide-filter"
                                class="p-button-sm"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-none"
                                 inputId="sort-none"
                                 data-testid="tags-filters-sort-none"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-ascending"
                                 ...
                                 data-testid="tags-filters-sort-ascending"
                                 value="updated_at"
                                 v-model="store.query.filter.sort" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-descending"
                                 ...
                                 data-testid="tags-filters-sort-descending"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-all"
                                 inputId="active-all"
                                 value="null"
                                 data-testid="tags-filters-active-all"
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-true"
                                 inputId="active-true"
                                 data-testid="tags-filters-active-true"
                                 value="true"
                                 v-model="store.query.filter.is_active" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-false"
                                 ...
                                 data-testid="tags-filters-active-false"
                                 value="false"
                                 v-model="store.query.filter.is_active" />
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-exclude"
                                 ...
                                 data-testid="tags-filters-trashed-exclude"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-include"
                                 ...
                                 data-testid="tags-filters-trashed-include"
                                 value="include"
                                 v-model="store.query.filter.trashed" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-only"
                                 ...
                                 data-testid="tags-filters-trashed-only"
                                 value="only"
                                 v-model="store.query.filter.trashed" />
