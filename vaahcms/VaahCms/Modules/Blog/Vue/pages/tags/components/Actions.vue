                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="tags-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="tags-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                type="button"
                                class="p-button-sm"
                                :disabled="Object.keys(route.params).length"
                                data-testid="tags-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="tags-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
                                ...
                                <Button
                                    ...
                                    data-testid="tags-actions-bulk-menu"
                                    aria-haspopup="true"
